...
const PHILOSOPHY =
  "BAYADA는 모든 사람이 가정에서 존엄하고 편안하게 생활할 권리가 있다고 믿습니다. 열정, 탁월함, 신뢰의 핵심 가치를 바탕으로 최고 품질의 홈헬스케어 서비스를 제공하며, 이를 통해 모든 연령대의 사람들이 최상의 삶의 질을 경험할 수 있도록 합니다.";
            ...
            {activeTab === "values" ? (
              ...
              >
                <div className="rounded-2xl bg-white p-10 shadow-sm lg:p-14">
                  ...
                  <p className="text-lg leading-[1.85] text-black/70">
                    {PHILOSOPHY}
                  </p>
